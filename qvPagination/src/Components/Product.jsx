...
function Product({name="Nike Shoes",price=499, displayPrice=999, img, discount=39}) {
  ...
  return (
    <div className="group my-5 flex w-1/4 max-w-md h-max flex-col overflow-hidden rounded-lg border border-gray-100 bg-white shadow-md hover:scale-105 hover:shadow-cyan-400 ">
      <a
